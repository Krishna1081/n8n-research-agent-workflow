    ...
    if (files && Object.keys(files).length) {
      ...
      for (const fileKey of Object.keys(files)) {
        ...
        for (const file of processedFiles) {
          ...
          const binaryInfo = {
            ...(0, import_lodash.pick)(binaryFile, ["fileName", "fileSize", "fileType", "mimeType", "fileExtension"]),
            binaryKey
          };
  ...
  async webhook(ctx) {
    ...
    if (nodeMode === "hostedChat") {
      if (webhookName === "setup") {
        ...
        const i18nConfig = (0, import_lodash.pick)(options, ["getStarted", "inputPlaceholder", "subtitle", "title"]);
