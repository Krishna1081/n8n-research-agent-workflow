...
export declare class DataStoreRepository extends Repository<DataTable> {
    ...
    createDataStore(projectId: string, name: string, columns: DataStoreCreateColumnSchema[], trx?: EntityManager): Promise<DataTable>;
    deleteDataStore(dataStoreId: string, trx?: EntityManager): Promise<boolean>;
    transferDataStoreByProjectId(fromProjectId: string, toProjectId: string, trx?: EntityManager): Promise<boolean>;
    deleteDataStoreByProjectId(projectId: string, trx?: EntityManager): Promise<boolean>;
    deleteDataStoreAll(trx?: EntityManager): Promise<boolean>;
