...
export declare class DataStoreController {
    ...
    upsertDataStoreRow(req: AuthenticatedRequest<{
        projectId: string;
    }>, _res: Response, dataStoreId: string, dto: UpsertDataStoreRowDto): Promise<true | DataStoreRowReturn[] | import("n8n-workflow").DataStoreRowReturnWithState[]>;
    updateDataStoreRows(req: AuthenticatedRequest<{
        projectId: string;
    }>, _res: Response, dataStoreId: string, dto: UpdateDataTableRowDto): Promise<true | DataStoreRowReturn[] | import("n8n-workflow").DataStoreRowReturnWithState[]>;
    deleteDataTableRows(req: AuthenticatedRequest<{
        projectId: string;
    }>, _res: Response, dataTableId: string, dto: DeleteDataTableRowsDto): Promise<DataStoreRowReturn[]>;
}
