...
import type { DataStoreColumnJsType, DataStoreRowReturn, DataStoreRows, DataTableInsertRowsReturnType, DataTableInsertRowsResult, DataTablesSizeResult, DataStoreRowReturnWithState } from 'n8n-workflow';
...
export declare class DataStoreService {
    ...
    upsertRow<T extends boolean | undefined>(dataTableId: string, projectId: string, dto: Omit<UpsertDataStoreRowDto, 'returnData' | 'dryRun'>, returnData: true, dryRun?: boolean): Promise<DataStoreRowReturn[] | DataStoreRowReturnWithState[]>;
    upsertRow(dataTableId: string, projectId: string, dto: Omit<UpsertDataStoreRowDto, 'returnData' | 'dryRun'>, returnData?: boolean, dryRun?: true): Promise<DataStoreRowReturnWithState[]>;
    upsertRow(dataTableId: string, projectId: string, dto: Omit<UpsertDataStoreRowDto, 'returnData' | 'dryRun'>, returnData?: false, dryRun?: false): Promise<true>;
    validateUpdateParams({ filter, data }: Pick<UpdateDataTableRowDto, 'filter' | 'data'>, columns: DataTableColumn[]): void;
    updateRows<T extends boolean | undefined>(dataTableId: string, projectId: string, dto: Omit<UpdateDataTableRowDto, 'returnData' | 'dryRun'>, returnData: true, dryRun?: boolean): Promise<DataStoreRowReturn[] | DataStoreRowReturnWithState[]>;
    updateRows(dataTableId: string, projectId: string, dto: Omit<UpdateDataTableRowDto, 'returnData' | 'dryRun'>, returnData?: boolean, dryRun?: true): Promise<DataStoreRowReturnWithState[]>;
    ...
    deleteRows(dataStoreId: string, projectId: string, dto: Omit<DeleteDataTableRowsDto, 'returnData' | 'dryRun'>, returnData: true, dryRun?: boolean): Promise<DataStoreRowReturn[]>;
    deleteRows(dataStoreId: string, projectId: string, dto: Omit<DeleteDataTableRowsDto, 'returnData' | 'dryRun'>, returnData?: boolean, dryRun?: true): Promise<DataStoreRowReturn[]>;
    deleteRows(dataStoreId: string, projectId: string, dto: Omit<DeleteDataTableRowsDto, 'returnData' | 'dryRun'>, returnData?: false, dryRun?: false): Promise<true>;
