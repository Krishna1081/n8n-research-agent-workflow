...
let FrontendService = class FrontendService {
    constructor(globalConfig, logger, loadNodesAndCredentials, credentialTypes, credentialsOverwrites, license, mailer, instanceSettings, urlService, securityConfig, modulesConfig, pushConfig, binaryDataConfig, insightsService, licenseState) {
    ...
    getSettings() {
        ...
        this.settings.logsView.enabled = config_2.default.get('logs_view.enabled');
