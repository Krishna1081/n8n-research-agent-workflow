...
class Github {
    ...
    async execute() {
        ...
        if (resource === 'workflow' && operation === 'dispatchAndWait') {
            const owner = this.getNodeParameter('owner', 0, '', { extractValue: true });
            ...
            const ref = this.getNodeParameter('ref', 0, '', { extractValue: true });
            const inputs = (0, GenericFunctions_1.validateJSON)(this.getNodeParameter('inputs', 0));
            if (!inputs) {
                throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Inputs: Invalid JSON');
            }
            ...
            try {
                ...
                if (error.httpCode === '404' || error.statusCode === 404) {
                    throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'The workflow to dispatch could not be found. Adjust the "workflow" parameter setting to dispatch the workflow correctly.', { itemIndex: 0 });
                }
            ...
            try {
                ...
                if (resource === 'file') {
                    if (['create', 'edit'].includes(operation)) {
                        ...
                        // ----------------------------------
                        requestMethod = 'PUT';
                        const filePath = (0, utilities_1.removeTrailingSlash)(this.getNodeParameter('filePath', i));
                        ...
                        if (this.getNodeParameter('binaryData', i)) {
                            ...
                            if ((0, GenericFunctions_1.isBase64)(fileContent)) {
                    ...
                    if (operation === 'getRepositories') {
                        ...
                        requestMethod = 'GET';
                        endpoint = '/issues';
                        qs = this.getNodeParameter('getUserIssuesFilters', i, {});
                        returnAll = this.getNodeParameter('returnAll', 0);
                        if (!returnAll) {
                            qs.per_page = this.getNodeParameter('limit', 0);
                        }
                    ...
                    if (operation === 'dispatch') {
                        ...
                        endpoint = `/repos/${owner}/${repository}/actions/workflows/${workflowId}/dispatches`;
                        const ref = this.getNodeParameter('ref', i, '', { extractValue: true });
                        body.ref = ref;
                        const inputs = (0, GenericFunctions_1.validateJSON)(this.getNodeParameter('inputs', i));
                        if (inputs === undefined) {
                            throw new n8n_workflow_1.NodeOperationError(this.getNode(), 'Inputs: Invalid JSON', {
                                itemIndex: i,
                            });
